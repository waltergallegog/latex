...
\subsubsection*{Save Wallet action}
...
\subsection{zxcvbn Password strength estimator} \label{sec:zxcvbn}
...
%During the application development an strange and elusive bug was found: The SecureSqlite library 
%
%I may have managed to solve the fat32 bug, but I'm not entirely sure. Sorry it took me so long, but I was expecting the error to be in the secureSqlite library and not in SEfile.
%I tested both my application and SecureSqliteBrowser, and they are working correctly, if you can also test that would be great.
%The error I found was in the SEfile library, in the sefile.c file. Attached you can the modified version of it, and at the end of this email I copied/paste my comments on the modifications. All the changes were made in the secure_seek function. (around line 833)
%
%Regards,
%Walter Gallego
